...
\begin{equation}
  \frac{1}{r} \frac{\partial}{\partial r} (\frac{4(r^2 -\sigma^2)}{\sigma^4} \cdot \frac{\partial z(r,t)}{\partial r}) = \rho c_d \frac{\partial z}{\partial t} - q(r,t)
...
\begin{figure}[H]
  \centering
  \input{slike/vrtaca-ravnovesje-z.png}
  \caption{Casovna odvisnost modela nastajanja}
  \label{fig:difuzijski-casovna-odvisnost-z}
\end{figure}

\begin{figure}[H]
  \centering
  \input{slike/vrtaca-ravnovesje-q.png}
  \caption{Casovna odvisnost q pri modelu nastajanja vrtače}
