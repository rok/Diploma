...
Rezultat (\ref{difuzijska-enacba-difuzijska-konstanta-2}) vstavimo v splošno difuzijsko enačbo (\ref{difuzijska-enacba-3}):
...
Časovni odvod dinamičnega nastavka za vrtačo (\ref{nastavek-dinamicno}) se torej pri difuzijski konstanti (\ref{difuzijska-enacba-difuzijska-konstanta-2}) ujema z rezultatom difuzijske enačbe (\ref{nastavek-dinamicno-odvod}). Minimalen nastavek za $k(z)$ pa je (\ref{difuzijska-enacba-difuzijska-konstanta-3}).
