...
[TODO]Doslej kolektivni opis statistične porazdelitve velikosti. Kaj pa posamezne vrtače? Bolj kompleksen problem, ker ni univerzalen, pač pa bi moral temeljiti na ustreznem dinamičnem modelu rasti ene same vrtače. Na to temo konsenza v literaturi ni. Pregled literature..
Lpt nadomestek (mikroskopskega) modela dinamike si ogledamo nekaj fenomenoloških modelov rasti, ki temeljijo na reakcijsko difuzijski dinamiki opisa rasti, ki je primeren za opis prostorsko porazdeljenih kemijskih reakcij.
Opišite en primer ko ko deluje!
Ima dva dela difuzijsko in deterministično dinamiko.[TODO]
    ...
    \end{equation}
[TODO]Nadrobnejši opis kaj to pomeni, v kakšnem kontekstu se to uporablja[TODO]
    \begin{equation}
