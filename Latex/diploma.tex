...
%naslovnica
 \thispagestyle{empty}%
   \begin{center}
    ...
    {\titfont Naslov diplomskega dela \par}%
...
\bibitem{Fiz1} Janez Strnad: Fizika. Del 1, Ljubljana, DMFA - založništvo, 2002
\bibitem{FLoP} Richard P. Feynman: The Feynman lectures on physics. Vol. 1,  Addison-Wesley, 1964
\end{thebibliography}
