...
\newpage
          ...
          Če izberemo $F(h) = a \cdot h$, dobimo:
            ...
            \begin{figure}[H]
              \begin{center}
                \includegraphics[width=14cm]{slike/difuzija-eksponentna-rast}
              \end{center}
...
\newpage
          ...
          Če izberemo $F(h) = h \cdot (1 - \frac{h}{K})$, dobimo:
            ...
            \begin{figure}[H]
              \begin{center}
                \includegraphics[width=14cm]{slike/difuzija-logisticna-rast}
              \end{center}
...
\newpage
          ...
          Če izberemo $F(h) = (K - h)$, dobimo:
            ...
            \begin{figure}[H]
              \begin{center}
                \includegraphics[width=14cm]{slike/difuzija-omejena-eksponentna-rast}
              \end{center}
              \caption{Vzeli smo $D=10$, $a=1$, $K=100$ in majno začetno porazdelitev, ki povzroči začetek rasti - slika a) \cite{kandler2010population}}
...
\newpage
          ...
          Če izberemo $F(h) = h \cdot a_0 e^{-a t}$, dobimo:
            ...
            \begin{figure}[H]
              \begin{center}
                \includegraphics[width=14cm]{slike/difuzija-gompertzova-rast}
              \end{center}
              \caption{Vzeli smo $D=10$, $a=1$ in majno začetno porazdelitev, ki povzroči začetek rasti - slika a) \cite{kandler2010population}}
