...
Model dopolnimo z raztapljanjem in izpiranjem delno raztopljene kamnine v podzemlje - to pospravimo v člen $Q_s$.
\begin{equation}
  \rho_s \frac{\partial h}{\partial t} = -\rho_r \frac{\partial z_b}{\partial t} - \nabla q_s - Q_s
...
\begin{figure}[H]
  \begin{center}
    \includegraphics{slike/vrtaca-aggtelek.jpg}
  \end{center}
  \caption{Meritve odtekanja vode in raztapljanja apnenca realni vrtači v dolini Beke na Madžarskem je opisal \cite{Zambo1997}}
