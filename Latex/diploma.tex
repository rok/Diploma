...
\begin{center} {\Large \textbf{\sc Izjava o avtorstvu diplomskega dela}} \end{center}
  ...
  % prazna stran
    ...
    % prazna stran
        ...
        \begin{equation}
          z(r,\infty) = A\left(1-e^{-\left(\frac{r}{\sigma }\right)^2}\right)
        ...
        \begin{equation}
          K(z) = -\frac{\frac{1}{A} z(r,\infty) \sigma ^4 e^{-\frac{t}{\tau}}}{4 \left(e^{-t/\tau } - 1 \right) r^2 \tau }
          \label{difuzijska-konstanta-2}
        \end{equation}
