...
To informacijo lahko uporabimo tako, da gaussovo funkcijo fitamo na realne vrtače in tako dobimo precej dobre lokacije njihovih najnižjih točk, ter njihove $\sigma_x$ in $\sigma_y$. Z lokacijami najnižjih točk lahko izmerimo povprečne profile vrtač z istimi efektivnimi polmeri, naprimer: Slika \ref{fig:menisija-profil-21}

\begin{figure}[H]
  \centering
  \includegraphics{slike/menisija-profil-21}
  \caption{Povprecje profilov vrtač z efektivnimi polmeri med 20m in 22m }
...
Zdi se, da so vrtače podobne oblike ne glede na velikost po celi površini, le v normalno površje se iztečejo po različnih pretečenih polmerih.
Če dobljene profile fitamo \dots
